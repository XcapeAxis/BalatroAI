...
- P18/P19 fixes (failure-bucket path, ablation routing, max_steps, canary synthetic label, regression tests) do not change P17 behaviour. P17 remains the baseline for P18/P19 gates.
