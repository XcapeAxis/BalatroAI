...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Analyze P9 episode oracle/sim mismatch and emit categorized tables.")
...
def main() -> int:
    ...
    report_path = fixtures_dir / "report_p9.json"
        ...
        rows.append(
            {
                ...
                "boss_key": str(result.get("boss_key") or ""),
                "tag_key": str(result.get("tag_key") or ""),
    ...
    csv_path = fixtures_dir / "episode_mismatch_table_p9.csv"
    md_path = fixtures_dir / "episode_mismatch_table_p9.md"
    ...
    lines: list[str] = []
    lines.append("# P9 Episode Mismatch Table")
    lines.append("")
