...
def main() -> int:
    ...
    if int(args.workers) != 1:
        print(f"[P2] workers={args.workers} requested; forcing workers=1 for deterministic oracle alignment.")
    ...
    for target in selected_targets:
        ...
        for attempt in range(int(args.max_retries) + 1):
            ...
            print(f"[P2] target={target} attempt={attempt + 1}/{int(args.max_retries) + 1} generating trace...")
    ...
    print(
        f"[P2] done total={len(rows)} pass={passed} diff_fail={diff_fail} "
