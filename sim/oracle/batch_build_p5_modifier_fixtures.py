...
from sim.oracle.generate_p5_modifier_trace import generate_one_trace, load_supported_entries
from sim.oracle.p5_modifier_classifier import build_and_write
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Batch-build P5 modifier fixtures and run directed oracle/sim diff.")
    parser.add_argument("--base-url", default="http://127.0.0.1:12346")
    parser.add_argument("--out-dir", default="sim/tests/fixtures_runtime/oracle_p5_modifiers_v1")
    parser.add_argument("--max-steps", type=int, default=260)
    parser.add_argument("--seed", default="AAAAAAA")
    parser.add_argument("--scope", choices=SCOPE_CHOICES, default="p5_modifier_observed_core")
...
def _write_status_doc(project_root: Path, report: dict[str, Any], classifier_summary: dict[str, Any]) -> Path:
    ...
    lines: list[str] = []
    lines.append("# P5 Modifier Fixture Coverage Status")
    lines.append("")
