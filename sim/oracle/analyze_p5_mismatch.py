...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Analyze P5 oracle/sim mismatch and emit categorized tables.")
...
def _classify(row: dict[str, Any], first_action: dict[str, Any]) -> str:
    ...
    if "modifier" in path:
        return "modifier_state_mismatch"
...
def main() -> int:
    ...
    csv_path = fixtures_dir / "score_mismatch_table_p5.csv"
    md_path = fixtures_dir / "score_mismatch_table_p5.md"
    ...
    lines: list[str] = []
    lines.append("# P5 Mismatch Table")
    lines.append("")
