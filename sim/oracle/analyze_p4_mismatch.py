...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Analyze P4 oracle/sim mismatch and emit categorized tables.")
...
def _classify(row: dict[str, Any], first_action: dict[str, Any]) -> str:
    ...
    if "consumables" in path:
        return "consumable_inventory_mismatch"
    if "hands.levels" in path or "hands." in path:
        return "hand_level_mismatch"
...
def main() -> int:
    ...
    report_path = fixtures_dir / "report_p4.json"
    ...
    csv_path = fixtures_dir / "score_mismatch_table_p4.csv"
    md_path = fixtures_dir / "score_mismatch_table_p4.md"
    ...
    lines: list[str] = []
    lines.append("# P4 Mismatch Table")
    lines.append("")
