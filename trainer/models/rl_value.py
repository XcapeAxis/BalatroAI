...
class RLValue(nn.Module):
    """Value head over a shared encoder for state-value estimation."""
    ...
    def __init__(
        ...
        *,
        ...
        self.value_head = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Linear(max(16, self.latent_dim), 1),
        )
    ...
    def save(self, path: str) -> None:
        torch.save({"state_dict": self.state_dict(), "obs_dim": self.obs_dim}, path)
