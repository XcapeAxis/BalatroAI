...
class PPOHardCaseSamplingConfig:
    ...
    source_variant_sampling_weights: dict[str, float] = field(default_factory=dict)
    source_variant_minimum_counts: dict[str, int] = field(default_factory=dict)
    source_variant_quota_caps: dict[str, int] = field(default_factory=dict)
...
class PPOConfig:
    ...
    def from_mapping(cls, raw: dict[str, Any] | None) -> "PPOConfig":
        ...
        hard_case_cfg = PPOHardCaseSamplingConfig(
            ...
            source_variant_sampling_weights=_as_float_mapping(hard_case_raw.get("source_variant_sampling_weights")),
            source_variant_minimum_counts=_as_int_mapping(hard_case_raw.get("source_variant_minimum_counts")),
            source_variant_quota_caps=_as_int_mapping(hard_case_raw.get("source_variant_quota_caps")),
